 ...
 * @return void
 **/
function checkdatedown(obj){
if(event.keyCode==13){if(obj.value!=''){chkdate(obj);}else{event.keyCode=9;}}

}

function chkdatedown(obj){
if(event.keyCode==13){if(obj.value!=''){chkdate(obj);}else{event.keyCode=9;}}
...
//how to call :: onKeyPress=\"return numbersonly(this, event)\"
