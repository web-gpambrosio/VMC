...
if (isset($_GET['rankcode']))
	$currentrankcode_tmp = $_GET['rankcode'];
...
$tmpcurrent_rankcode = $currentrankcode;

$currentrankcode = $currentrankcode_tmp;

$qryrank = mysql_query("SELECT RANK FROM rank WHERE RANKCODE='$currentrankcode' AND STATUS=1") or die(mysql_error());

$rowrank = mysql_fetch_array($qryrank);
$intendedrank = $rowrank["RANK"];

$qryrank2 = mysql_query("SELECT RANK FROM rank WHERE RANKCODE='$tmpcurrent_rankcode' AND STATUS=1") or die(mysql_error());

$rowrank2 = mysql_fetch_array($qryrank2);
$curr_rank = $rowrank2["RANK"];
...
<body onload=\"\" style=\"background-color:White;overflow:auto;\">\n
	...
	<div style=\"width:1000px;height:680px;background-color:White;margin:5 5 5 5;\">
		...
		";
			$stylehdr = "style=\"font-size:0.75em;font-weight:Bold;\"";
			$styledtl2 = "style=\"font-size:0.8em;font-weight:Bold;text-decoration:underline;\"";
		echo "
			<div style=\"width:80%;height:100%;float:left;\">
				<span style=\"font-size:0.7em;font-weight:Bold;color:Black;float:right;\">FM-249M <br /> REV. JUNE 2008</span>
				<span style=\"font-size:1.3em;font-weight:Bold;text-align:center;\">Training Checklist (By Rank)</span>&nbsp;&nbsp;
				<span style=\"font-size:0.8em;font-weight:Bold;color:Black;\">(PRINT DATE: &nbsp;&nbsp;$currentdateshow)</span>
				<hr />
<!--
...
-->
				<table style=\"width:40%;float:left;border-right:1px solid Gray;\">
					...
					<tr>
						<td colspan=\"3\" align=\"left\" style=\"font-size:0.9em;font-weight:Bold;color:Blue\">For Rank:&nbsp;&nbsp;$intendedrank Checklist</td>
					</tr>
				</table>
				<table style=\"width:30%;float:left;border-right:1px solid Gray;\">
					...
					<tr>
						<td colspan=\"3\" align=\"left\" style=\"font-size:0.9em;font-weight:Bold;color:Magenta;\">Current Rank:&nbsp;&nbsp;$curr_rank</td>
					</tr>
				</table>
			...
			include("veritas/include/checklist.inc");
				...
				if (mysql_num_rows($qrychecklist) > 0)
				{
					echo "
						...
						<table width=\"100%\" style=\"font-size:0.75em;background-color:White;border:1px solid black;\">
							<tr style=\"font-weight:bold;color:Black;\">
								<td width=\"40%\" align=\"center\"><u>COURSE</u></td>
								<td width=\"10%\" align=\"center\"><u>TRAIN DATE</u></td>
								<td width=\"40%\" align=\"center\"><u>STATUS</u></td>
								<td width=\"10%\" align=\"center\"><u>SCANNED</u></td>
							</tr>
							";
...
//										$chkrequiredshow = "Y";
									...
									$endorsed = 0;
									$qrytrainendorse = mysql_query("SELECT TRAINCODE FROM trainingendorsement 
														WHERE APPLICANTNO=$applicantno AND TRAINCODE='$chktraincode' 
														AND SCHEDID IS NULL") or die(mysql_error());
									...
									if (mysql_num_rows($qrychecklistinhouse) > 0)
									{
										...
										switch ($status2)
										{
											...
											case "FINISHED"	:
													...
													$statusshow = "<i>&nbsp;&nbsp; Ended:&nbsp;"  .$dateto . "</i>&nbsp;--->&nbsp;&nbsp;<span style=\"font-weight:Bold;\">&nbsp;$completed&nbsp;</span>";
...
//									}
	...
	<br />
	<div style=\"width:1000px;height:40px;background-color:White;margin:10 10 10 10;\">
		...
		<table style=\"width:25%;float:left;font-size:0.75em;\">
			<tr><td style=\"border-top:1px solid black;\"><b>SHAMAINE D. DAGAAS</b></td></tr>
			<tr><td>Training Assistant - Division 2</td></tr>
			<tr><td>&nbsp;</td></tr>
		</table>
		
		<table style=\"width:25%;float:right;font-size:0.75em;\">
			<tr><td style=\"border-top:1px solid black;\"><b>LEXINGTON CALUMPANG</b></td></tr>
