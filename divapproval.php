...
if (isset($_POST['divremarks']))
	$divremarks = $_POST['divremarks'];
...
switch ($actiontxt)
{
	case "approve"	:
			...
			{
				$qryappstatusupdate = mysql_query("UPDATE applicantstatus SET DIVBY='$employeeid', DIVDATE='$currentdate',
												DIVREMARKS='$divremarks'
...
$qryforapproval = mysql_query("SELECT at.APPLICANTNO,CONCAT(FNAME,', ',GNAME,' ',MNAME) AS NAME,ax.PASSED,
        					...
        					AND at.APPROVEDDATE IS NOT NULL
        					AND at.DIVDATE IS NULL
        					$whererank
...
<form name=\"divisionapproval\" method=\"POST\">\n

<span class=\"wintitle\">DIVISION APPROVAL</span>
...
<div style=\"width:1019px;border-bottom:1px solid black;\">
	...
	<div style=\"width:185px;height:650px;float:left;background-color:#999AFF\">
		...
		<div style=\"width:100%;height:520px;float:left;\">
	...
	";
		...
		<div style=\"width:815px;height:140px;background-color:Black;overflow:hidden;margin: 0 0 0 10;\" >
			<table style=\"color:White;font-size:0.7em;font-weight:Bold;width:30%;float:left;\">
				<tr>
					<td>Remarks<br />
						<textarea rows=\"6\" cols=\"40\" name=\"divremarks\">$divremarks</textarea>
					</td>
				</tr>
			</table>
