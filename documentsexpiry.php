...
<form name=\"documentsexpiry\" method=\"POST\">
	...
	<div style=\"width:100%;height:500px;padding:5px 20px 0 20px;overflow:hidden;\">
		<br />
		<span class=\"sectiontitle\">REPORTS - Documents Expiry</span>
		...
		<input type=\"button\" value=\"View\" onclick=\"if(bdate.value=='' || edate.value==''){alert('Input Beg & End date')}else{
			openWindow('reports/repdocumentsexpiry.php?bdate='+bdate.value+'&edate='+edate.value, 'repexpiry' ,'850px', '750px')};\" />
		<br />
	</div>
