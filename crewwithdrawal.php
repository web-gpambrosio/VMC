...
<form name=\"crewwithdrawal\" method=\"POST\">
	
	<center>
	<div style=\"width:100%;height:500px;padding:5px 20px 0 20px;overflow:hidden;\">
		<br />
		<span class=\"sectiontitle\">REPORTS - Crew Withdrawal</span>
		...
		<input type=\"button\" value=\"View\" onclick=\"if(bdate.value=='' || edate.value==''){alert('Input Beg & End date')}else{
			openWindow('reports/repcrewwithdrawal.php?bdate='+bdate.value+'&edate='+edate.value, 'repcrewwithdraw' ,1250,600)};\" />
		<br />
	</div>
