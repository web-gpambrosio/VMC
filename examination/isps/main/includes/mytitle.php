...
<table width="724" height="62" border="0" cellpadding="0" cellspacing="0">
      ...
      <td style="border-bottom:3px double #aaaaaa" height="21" align="left" valign="top">
      <div class="admin_label"><em><strong>SCHEDULER</strong></em>
          <a href="sched_edit.php?empno=<?php echo $empno . '&edit=' . $id; ?>">
            <span class="green2"><em><strong>(<u>EDIT ACCOUNT</u>)</strong></em></span>
          </a>
      </div></td>
