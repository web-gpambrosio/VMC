...
$percentscoref = round($percentscf, 2);	
		...
		$subject = "ISPS Online Examination";
		$message = "RESULTS OF EXAMINATION\n
					Name: ".$gname." ".$mname.". ".$fname."\n
					Type of Exam: ".$exam."\n
					Result: ".$scoref."/".$totalnof." (". $percentscoref ."%)\n
					Thank you.";
		$from = "ISPS Online Examination <isps_onlineexam@veritas.com.ph>";
		$headers = "From: $from";
		mail($to2,$subject,$message,$headers);

echo "<script type='text/javascript'>alert('Your Score for ". $exam ." exam is ". $percentscoref ."%. Thank you!')</script>" ;
echo "<script language=\"javascript\">window.location.href = 'close.php';</script>";
?>
<html>
<head>
<title>ISPS - International Safety Management</title>
</head>
