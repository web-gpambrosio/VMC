...
$menu = '<table width="428" border="0" cellspacing="0" cellpadding="0">'
		...
		'index.php?empno='.$empno
		
		.'" class="ahref" onmouseover="this.style.textDecoration=\'underline\'" onmouseout="this.style.textDecoration=\'none\'">HOME</a> '
		.' <img src="../../images/home.gif" width="10" height="10" border="0"/> &nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;'
		.'<a href="'.
		
		'isps_crew.php?empno='.$empno
		
		.'" class="ahref" onmouseover="this.style.textDecoration=\'underline\'" onmouseout="this.style.textDecoration=\'none\'">'
		.'LIST OF CREW</a> <img src="../../images/people.gif" height="10" border="0"/> &nbsp;&nbsp;|&nbsp;&nbsp;'
		.'<a href="'.
		
		'report.php?empno='.$empno
		
		.'" class="ahref" onmouseover="this.style.textDecoration=\'underline\'" onmouseout="this.style.textDecoration=\'none\'">REPORT</a> '
		.' <img src="../../images/report.gif" width="10" height="10" border="0"/> &nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;'
