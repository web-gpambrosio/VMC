...
$admin_add="Select empno from scheduler order by id desc limit 1";
$admin_add_query=mysql_query("$admin_add",$conn);	
$admin_add_row=mysql_num_rows($admin_add_query);

if ($admin_add_row != '0')
	{
		$scheduler_empno_id=mysql_result($admin_add_query,0,"empno");
	}
else
	{
		$scheduler_empno_id = 1000;
	}

$scheduler_empno_id = $scheduler_empno_id + 1;
...
if (sizeof($error) == 0)
{
$queryv = "insert into scheduler (empno, lname, fname, mname, position, contactno, bdate, bplace, email, password) values ('$scheduler_empno_id', '$lname', '$fname', '$mname', '$position', '$contactno', '$bdate', '$bplace', '$email', '$newpassword')";
...
echo "<script language=\"javascript\">window.location.href='scheduler_setting.php?adminno=" . $adminno . "'</script>";
...
<form action="" method="post" enctype="multipart/form-data" name="form" id="form">
            <table width="629" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="17" align="right"><a href="scheduler_setting.php?adminno=<?php echo $adminno; ?>" style="text-decoration:none; color:#0033FF">Cancel</a></td>
              </tr>
              <tr>
                <td height="5"></td>
              </tr>
              <tr>
                <td width="629" height="47" align="left" valign="top"><table width="629" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <div style="font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;New Scheduler Account</div>
                      </td>
                      <td width="1" height="32"><img src="../images/gray_side.gif" width="1" height="32"/></td>
                    </tr>
                  </table>
              ...
              <tr>
                <td height="17" align="center"><table width="382" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <input name="txtempno" type="hidden" id="txtempno" style="font-size:12px" size="40" height="12" value="<?php echo $txtempno; ?>"/>
                    <?php echo $scheduler_empno_id; ?>
