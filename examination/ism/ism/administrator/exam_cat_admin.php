...
if (trim($txtcat) != '')
{
	...
	{
		$cat01=mysql_query("Select cat from category where cat='$txtcat'",$conn);
...
elseif (trim($txtcat) == '') { $error[0] = "<div class='warning_message'>Enter Category</div>"; }

if (sizeof($error) == 0)
{
$queryv = "insert into category (cat) values ('$txtcat')";
...
echo "<script language=\"javascript\">window.location.href='exam_cat_admin.php?adminno=" . $empno . "'</script>";
...
<title>Category of Examination</title>
...
<form action="" method="post" enctype="multipart/form-data" name="form" id="form">
            <table width="629" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <a href="admin_setting.php?adminno=<?php echo $empno; ?>" style="text-decoration:none; color:#0033FF">Home</a> &nbsp;&nbsp;&nbsp;
                <a href="../connection/s_logout.php" style="text-decoration:none; color:#0033FF">Log Out</a>
                </td>
              </tr>
              <tr>
                <td height="5"></td>
              ...
              <tr>
                <td width="629" height="47" align="left" valign="top"><table width="629" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <div style="font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;Category of Examination</div>
                      </td>
                      <td width="1" height="32"><img src="../images/gray_side.gif" width="1" height="32"/></td>
                    </tr>
                  </table>
              ...
              <tr>
                <td height="110" align="center"><table width="408" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td width="147" align="right">Category : </td>
                    <td width="17">&nbsp;</td>
                    <td width="244" align="left">
<input onChange="javascript:this.value=this.value.toUpperCase();" name="txtcat" type="text" id="txtcat" style="font-size:12px; width:228px" size="40" height="12"/>
...
$ii = $i+1;
			...
			$xcat=mysql_result($yq,$i,"cat");
			$xstat=mysql_result($yq,$i,"stat");
			
			switch($xstat)
			{
				case "0": $rowcolor="color:#000000";
						$approv = '<a href="exam_cat_admin_ac.php?adminno='.$empno.'&id='.$xid.'&paint=1"><img src="../images/failed.gif" border="0"/></a>';
				break;
				case "1": $rowcolor="color:#333333; text-decoration:line-through";
						$approv = '<a href="exam_cat_admin_ac.php?adminno='.$empno.'&id='.$xid.'&paint=0"><img src="../images/passed.gif" border="0"/></a>';
				break;
			}
echo '
<tr>
...
<span style="'.$rowcolor.'" text-decoration:none">'.$xcat.'</span></strong>
</td>
<td align="left" valign="top">'.$approv.'</td>
</tr>';
