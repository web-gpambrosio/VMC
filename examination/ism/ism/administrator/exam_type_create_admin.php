...
echo "<script language=\"javascript\">window.location.href='exam_type_create_admin.php?adminno=" . $empno . "'</script>";
...
<form action="" method="post" enctype="multipart/form-data" name="form" id="form">
            <table width="629" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="17" align="right"><a href="admin_setting.php?adminno=<?php echo $empno; ?>" style="text-decoration:none; color:#0033FF">Home</a> &nbsp;&nbsp;&nbsp;
                <a href="../connection/s_logout.php" style="text-decoration:none; color:#0033FF">Log Out</a> </td>
              </tr>
              <tr>
                <td height="5"></td>
              </tr>
...
<?php
$xq="Select * from type order by id asc";
...
$ii = $i+1;
			...
			switch($xstat)
			{
				case "0": $rowcolor="color:#000000";
						$approv = '<a href="exam_type_create_admin_ac.php?adminno='.$empno.'&id='.$xid.'&paint=1"><img src="../images/failed.gif" border="0"/></a>';
				break;
				case "1": $rowcolor="color:#333333; text-decoration:line-through";
						$approv = '<a href="exam_type_create_admin_ac.php?adminno='.$empno.'&id='.$xid.'&paint=0"><img src="../images/passed.gif" border="0"/></a>';
				break;
			}
echo '
<tr>
...
<td align="left" valign="top">'.$approv.'
</td>
</tr>';
