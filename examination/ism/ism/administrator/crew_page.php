...
$search_result2 = "SELECT distinct users.crewcode, users.fname, users.gname, users.mname, users.bdate FROM users WHERE users.gname != '' and users.fname != '' and users.crewcode != '' and users.principal = '$tnkc' and users.$zzz LIKE '$txtsearch%'";
                  ...
                  <table width="581" height="80" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="8" colspan="6" align="left"><br />
                          ...
                          <input type="hidden" name="tnkc" id="tnkc" value="<?php echo $tnkc; ?>"/>
...
<?php
	...
	if($page > 1) { 
		echo "<a href=\"$PHP_SELF?page=1" . "&empno=$empno&tnkc=$tnkc&txtsearch=$txtsearch&xxx=$xxx\"><<</A>"; 
		echo "&nbsp;&nbsp;";
		echo "<a href=\"$PHP_SELF?page=" . ($page-1) . "&empno=$empno&tnkc=$tnkc&txtsearch=$txtsearch&xxx=$xxx\"><</A>"; 
		echo "&nbsp;&nbsp;";
		} 
	...
	for($i = $pagemin ; $i <= $pagemax ; $i++) { 
		if($i == $page) { 
			...
			echo "&nbsp;&nbsp;";
			echo "<a href=\"$PHP_SELF?page=$i&empno=$empno&tnkc=$tnkc&txtsearch=$txtsearch&xxx=$xxx\">$i</A>";
			echo "&nbsp;&nbsp;";
			} 
		} 
	...
	if($page < $NumberOfPages) { 
		...
		echo "<a href=\"$PHP_SELF?page=" . ($page+1) . "&empno=$empno&tnkc=$tnkc&txtsearch=$txtsearch&xxx=$xxx\">></A>"; 
		echo "&nbsp;&nbsp;";
		echo "<a href=\"$PHP_SELF?page=$NumberOfPages" . "&empno=$empno&tnkc=$tnkc&txtsearch=$txtsearch&xxx=$xxx\">>></A>"; 
		} 
