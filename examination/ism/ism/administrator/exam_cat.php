...
echo "<script language=\"javascript\">window.location.href='exam_cat.php?empno=" . $empno . "&tnkc=" . $tnkc . "'</script>";
            ...
            <table width="629" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="110" align="center"><table width="408" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td colspan="3" height="8"><div style="color:#FF0000"><strong>NOTE:</strong></div>
    <div style="color:#999999">If you want to delete one of the list, please contact ISM Super Administrator.<br />
      (<em>from Veritas Maritime Corp.</em>)</div></td>
                  </tr>
...
<?php
$xq="Select * from category where stat='0'";
