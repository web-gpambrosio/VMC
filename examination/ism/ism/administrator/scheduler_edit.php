...
$xcode="Select * from scheduler where empno='$empno'";
...
$bdate=mysql_result($query_result,0,"bdate");
$bplace=mysql_result($query_result,0,"bplace");
		...
		if (trim($newpassword) == '' || trim($confirmpassword) == '')
			{
				...
				{
					$error[10] = "<div class='warning_message'>Required field cannot be left blank</div>";
				}
			}
			else
			{
				...
				{
					$error[9] = "<div class='warning_message'>Passwords do not match</div>";
				}
			}
...
if (sizeof($error) == 0)
{
$queryv = "update scheduler set lname='$lname', fname='$fname', mname='$mname', position='$position', contactno='$contactno', bdate='$bdate', bplace='$bplace', email='$email', password='$newpassword' where id='$id'";
...
echo "<script language=\"javascript\">window.location.href='scheduler_setting.php?adminno=" . $admin . "'</script>";
...
<title>New Scheduler Account</title>
...
<form action="" method="post" enctype="multipart/form-data" name="form" id="form">
            <table width="629" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="17" align="right"><a href="scheduler_setting.php?adminno=<?php echo $admin; ?>" style="text-decoration:none; color:#0033FF">Cancel</a></td>
              </tr>
              <tr>
                <td height="5"></td>
              </tr>
              ...
              <tr>
                <td height="17" align="center"><table width="382" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td>&nbsp;</td>
                    <td align="left"><input name="confirmpassword" type="password" id="confirmpassword" style="font-size:12px; width:228px" size="40" height="12"/><div><?php echo $msg10; ?></div></td>
                  </tr>
                  <tr>
                    <td colspan="3" height="8"></td>
                  </tr>
