...
<form action="scheduler_query.php?<?php echo 'empno='.$empno.'&crewcode='.$xcrewcode; ?>" method="post" enctype="multipart/form-data" name="form" id="form">
...
echo '<tr><td align="right" valign="top"> Vessel : </td><td>&nbsp;</td><td align="left">';
	...
	/*echo '<input type="hidden" name="principalj" value="'. $rowprincipal[0] .'">';*/
	...
	$vtype_combo="Select distinct vessel.id, vessel.vessel, vessel.type from vessel, examtype where examtype.principal = '$rowprincipal[0]' and examtype.examname='$examnamem' and examtype.type = vessel.type and examtype.principal = vessel.principal";
