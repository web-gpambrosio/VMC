...
//		$arrmnldate = $rowcrewdtls["ARRMNLDATE"];
		...
		while($rowgethistory = mysql_fetch_array($qrygethistory))
		{
			...
			$viewform = "";
			$dir = $basedirdocs . $applicantno . "/CrewWithdrawalForm" . "_$zidno" . ".pdf";
			if (checkpath($dir,1))
			{
...
<span class=\"wintitle\">CREW WITHDRAWAL</span>
...
<div style=\"width:100%;background-color:White;\">
				...
				<div style=\"width:100%;height:70px;\">
					<table style=\"width:100%;\">
						...
						if (!empty($applicantno))
						{
							...
							<tr>
								<td colspan=\"3\" >
									<input type=\"text\" name=\"newdate\" value=\"$newdate\" onKeyPress=\"return dateonly(this);\" size=\"10\" maxlength=\"10\" onkeydown=\"chkdatedown(this);\">
									<img src=\"calendaricon.gif\" width=\"17\" height=\"17\" border=\"0\" onclick=\"popUpCalendar(newdate, newdate, 'mm/dd/yyyy', 0, 0);return false;\">
									&nbsp;&nbsp;
									<input type=\"button\" value=\"Create New\" onclick=\"if(newdate.value != '')
												{
													if('$liftfound' != '1')
													{
														actiontxt.value='create';applicantno.value=$applicantno;submit();
														openWindow('repwithdrawalform.php?applicantno=$applicantno&idno=$idno&crewname=$crewname&crewrank=$crewrank&crewvessel=$crewvessel&date='+newdate.value, 'viewdoc' ,900, 600);
													}
													else
													{
														alert('Previous Withdrawal entry not lifted yet. Can\'t create new entry.');
													}
												} else {alert('Input Date first.')}\" />
									}
								</td>
							</tr>
							";
	...
	echo "
		...
		<div style=\"width:100%;height:390px;margin:3 5 3 5;background-color:White;\">
			...
			if (!empty($applicantno) && !empty($idno))
			{
				echo "
				<iframe marginwidth=0 marginheight=0 id=\"withdrawalstatus\" frameborder=\"0\" name=\"content\" 
					src=\"withdrawalstatus.php?applicantno=$applicantno&idno=$idno\" scrolling=\"auto\" 
