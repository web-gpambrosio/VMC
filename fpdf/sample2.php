...
$pdf->AliasNbPages();
$pdf->connect('localhost','gino','shirly','test');
$attr=array('titleFontSize'=>18,'titleText'=>'GINO\'S REPORT');
$pdf->mysql_report("select * from TABLE1 where TRANSCODE='IA'",false,$attr);
?>